...
<h3>Tambah Buku</h3><hr>
	...
	if (isset($_POST['tambah'])) {
		$tambah = mysqli_query($db, "INSERT INTO lsp_buku VALUES('$_POST[no]','$tgl','$_POST[judul]','$_POST[pengarang]','$_POST[penerbit]','$_POST[tahun_terbit]','$_POST[asal]','$_POST[klasifikasi]')");
		if (isset($_GET['tambah'])) {
		$pinjam = mysqli_query($db, "INSERT INTO lsp_peminjaman VALUES('','$_GET[nama]','$_GET[kelas]','$_POST[no]','$tgl','$kembali','','','0')");
		if ($pinjam) {
	...
	<form method="post">
		<table width="100%">
			...
			<tr>
				<td></td>
				<td></td>
				<td><button type="submit" name="tambah" style="width:25%">Tambah</button></td>
			</tr>
		</table>
	</form>
	</center>
